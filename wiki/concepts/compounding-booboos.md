...
created: 2026-04-25
updated: 2026-07-14
sources: [raw/yt-building-pi-in-a-world-of-slop.md, raw/slowing-the-fuck-down.md, raw/2604.15597v1.md, raw/yt-are-we-really-doing-this-again.md, raw/2509.09677.md, raw/2511.09030.md, raw/2603.04474.md]
...
- `raw/2603.04474.md` — Xie, Zhu, Zhang et al. (City University of Macau + Minzu University, arXiv 2603.04474v2, 11 May 2026). §II propagation-dynamics model (`R ≈ βρ(A)/δ`); §IV three vulnerability classes (cascade amplification, topological fragility, consensus inertia). Source for the "Multi-Agent Face" section.
