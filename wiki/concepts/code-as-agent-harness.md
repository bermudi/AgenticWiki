...
- `raw/2605.18747.md` — Ning, Tieu, Fu et al. (2026). *Code as Agent Harness: Toward Executable, Verifiable, and Stateful Agent Systems.* The full survey defining the framework, taxonomy, and open problems across 102 pages.
