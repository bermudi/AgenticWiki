...
- `raw/recursive-agent-harnesses.txt` — Lumer, Sen, Paul, Subbiah (PricewaterhouseCoopers, 2026). *Recursive Agent Harnesses.* Full paper: §1 introduction, §2 related work, §3 RAH design, §4 experiments on Oolong-Synthetic, §5 limitations, §6 conclusion. Controlled evaluation with backbone held fixed at GPT-5 to match the Codex baseline.
