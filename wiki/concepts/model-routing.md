...
- `raw/2504.21625v6.md` — Meeseeks (Wang et al.): reasoning vs. non-reasoning model divergence over self-correction turns; routing signal for constraint-type tasks (word counts, proportions, mixed-language)
