...
- `raw/2503.13657.md` — Cemri, Pan, Yang et al. (UC Berkeley + Intesa Sanpaolo, NeurIPS 2025 Datasets & Benchmarks, arXiv 2503.13657v3, 26 Oct 2025). §4 MAST taxonomy (14 modes, 3 categories); §5.3 primacy of system design; Appendix B 41–86.7% failure rates; Appendix H intervention studies. Source for Layer 2 (the diagnosis).
- `raw/2512.08296.md` — Kim, Gu, Park et al. (Google Research + DeepMind + MIT, arXiv 2512.08296v3, 8 Apr 2026). §4.3 capability saturation (β = -0.236) and tool-coordination trade-off (β = -0.096); §4.4 error amplification factors (Independent 17.2×, Centralized 4.4×); three coordination regimes. Source for Layer 3 (the thresholds).
