...
arX iv:2607.13285v1 [cs.AI] 14 Jul 2026
...
1Tencent HY LLM Frontier 2Indiana University 3University of Maryland, College Park 4University of
...
1.System Overview               2.4 Main Loop                                                        L1                                  L2                                     L3
    ...
    1.2  Execution Workflow     use,and observation until the exit conditions are met                System Overview                     Component Overview                    Unit Deep Dive
    1.3  Design Principles      Purpose
                                Drive the agent to iteratively complete the task
                                                                                                                                                                                1
2. Execution Stages             Triggering Conditions                                                                                                                           2
                                                                                                                                                   Component                    3
    2.1  Initialization         Enter when loop starts or after each observation                                                               Stage                            4
    2.2  Planning               Input                                                                                                                                           5
                                Current state, observation, memory, tool results                                                                                                6
    2.3  Tool Execution                                                                                                                        Data      External Interface     7
                                Processing Steps                                                                                                                                9
    2.4 Main Loop (Repeat)      Reasoning, tool selection, action execution, observation
    2.5  Observation                                                                                 Overall description of the          Overview of all working units         Detailed analysis of each
...
3. State and Data               Related States                                                       execution model, major              outputs, and interactions.            and implementation.
                                Messages, scratchpad,tool results, loop counter                      stages, and system goals.
    3.1  Key States             Exceptional Cases
    3.2  Data Flow              Tool failure,parse error, max steps reached, timeout                 Information Included                Information Included                  Information Included
4.  Components                  Key Functions                                                                System architecture                   Component list& taxonomy      Detailed execution logic
                                _run_agent_loop(),_step(),_should_exit()                             Execution model                     Responsibilities& goals                 State transitions
    4.1  Prompting              Configurations                                                       Stage overview                      Inputs / outputs                        Exception handling
    4.2  Memory                 Max steps, retry policy, exit criteria                               Data& state flow                           Dependencies & interactions      Implementation details
    4.3  Tools                  Examples                                                             Design principles    Key states involved                                    Source code & snippets
    4.4  Others                 Typical execution trace and logs                                     Entry and exit conditions                                                   Logs & examples
                                Notes
                                Loop termination depends on multiple exit conditions                 Shallow(High-level)                                                         Deep (Implementation)

                Benefits of     Reduce Cognitive Load                     Improve Efficiency               Support Multiple Roles              Enhance Maintainability           Boost Learning
        Harness Handbook        Access the right information              Quickly locate relevant          Help developers, analysts,          Keep knowledge consistent         Facilitate onboarding and
                                at the right level.                       components and logic             and agents understand               and up-to-date.
                                                                                                           the system.                                                           knowledge transfer.
...
Source Repository         Static Analysis     Program Facts     Execution Skeleton Propose-Review Mapping Loop  Stable Mapping                                 Tier1 Overview
                                                                       Init                 Proposer           Initz                                            Architecture Overview
        agent-harness/                                                                 Propose Assignment                                                       Execution Model
        planner.py                                                     Setup      (Functions → Stages)         Setup                                            Stage Relationships
        executor.py       Functions / Methods  Functions Table         Loop        Proposals  Reject& Refine    Loop                                            Global State Flow
        memory.py         Call Graph      Call Graph                 Tool Call              Reviewer        Tier2 Stage Cards  Tier3Unit Cards
        tools/            State Read /Write    State Accesses                           Review & Feedback  Tool Call              Execution Stage Overview      Behavior
        parser.py         Classes/Modules      Unresolved Calls Log    Parse                                   Parse              Purpose& Responsibilities     Inputs/ Outputs
                          External Calls                              Finish                           Finish Accept              Execution Flow                State
...
(whether the rationale and supporting evidence are adequate). The weighted score is
    ...
    50                                                             Codex                     55.0        Terminus
    40              +10.0            +18.9    40.0    +10.0     +10.0       +10.0                    +13.3   +26.7                      0.12         -12.7%
    30                                        32.5                                           37.5                      +16.7            0.08                   -8.6%
    20          Codex Terminus                25.0    GPT-          Opus    DeepSeek         20.0    GPT-      Opus    DeepSeek         0.04     Codex      Terminus
...
planner tokens per request; lower values indicate greater efficiency.
                                                                ...
                                                                Baseline                Handbook-Assisted
                                 Localization                   40.0                    Scope Control                  40.0                     Reasoning
              40.0               +10.0        +6.6    +2.2      32.5        +3.3        -3.4                   +1.1    32.5        +13.4        +3.4            +3.3
              32.5     -10.0                                                                         +3.4                                                 -6.6
                                                                25.0                                                   25.0
              25.0
                40     +10.0     +23.3            +12.2         25.0        +10.0       +10.0                            40        +6.7                         +4.5
                30                            +3.4              17.5                                           +6.7      30                     +3.4      +3.3
                20                                                                                   +0.0                20
                10                                              10.0                                                     10
...
does not depend on any single judge.
    ...
    55    +26.7 +16.3                  60            +20.0      +33.3     50.0    +33.3         +11.2   50        +18.0    +3.7
    35                   +16.7         40    +3.3                         32.5        +5.4              40     +6.5
                                                                                                        30
    15    Q     CF       SH            20    Q      CF         SH         15.0    Easy Medium Hard      20     Easy Medium Hard
    ...
    at the reported granularity, so lower values are better.
                ...
                Harness        Level         Metric                      Baseline Handbook Gap Baseline Handbook Gap
                               ...
                               File          Precision     46.1       60.2        +14.1     53.0       62.2    +9.2
                                             F1            46.6       61.8        +15.2     47.3       52.3    +5.0
                Codex                        Wrong ↓       37.0       14.8        -22.2     21.4       21.4     0.0
                                             Recall        47.1       65.4        +18.3     46.4       49.1    +2.7
                               Symbol        Precision     38.0       55.3        +17.3     48.4       60.4    +12.0
                                             F1            38.3       57.1        +18.8     43.8       51.2    +7.4
                                             Wrong ↓       44.4       18.5        -25.9     28.6       21.4    -7.2
                                             Recall        74.7       83.9        +9.2      76.1       87.5    +11.4
                               File          Precision     74.1       86.2        +12.1     78.3       93.3    +15.0
                                             F1            74.1       84.7        +10.6     76.5       89.3    +12.8
                Terminus-2                   Wrong ↓       24.1       13.8        -10.3     20.0       6.7     -13.3
                                             Recall        64.7       76.3        +11.6     73.0       87.5    +14.5
                               Symbol        Precision     65.1       78.4        +13.3     73.9       93.3    +19.4
...
G' and (S', U g' ) with B', the fixed g, and Θ (plus S0 in function mode) as K'        , and renders and packages the
                                                                              g
validated (D'     ') with K'
              , Z      g as H'. The pair (R', H') becomes the starting state for the next request.
...
entry corresponds to one file.
                   ...
                   (Phase I)       Boundary nodes                            41           4,016
                                   ...
                                   Stages (L2)                               20             140
                   Built           L3 entries                               106           2,267
                   handbook        State registers                           10              62
